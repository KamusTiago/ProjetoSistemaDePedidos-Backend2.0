...
import com.kamustiago.kamus.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Jocian Feitosa Da Silva", "tiagokamus@outlook.com", "5464565645",
				TipoCliente.PESSOA_FISICA, pe.encode("125454543"));
		cli1.getTelefones().addAll(Arrays.asList("345956", "336945425"));

		Cliente cli2 = new Cliente(null, "Tiago Silva", "tiagokamus80@gmail.com", "91706727097",
		...
		Endereco e3 = new Endereco(null, "Avenida florianio", "2106", null, "centro", "669804", cli2, c2);
