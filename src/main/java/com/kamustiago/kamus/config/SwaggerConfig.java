package com.kamustiago.kamus.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.kamustiago.kamus.resources"))
	...
	private ApiInfo apiInfo() {
		 return new ApiInfo(
			 ...
			 "Esta API é foi desenvolviva com base nas aulas do curso spring boot do professor Nelio Alves",
			 "Versão 1.0",
			 "",
		 new Contact(
			 "Tiago Silva", "https://github.com/KamusTiago", "tiagokamus40@gmail.com"),
